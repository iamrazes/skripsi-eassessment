    ...
    <div class="relative flex items-center justify-center">
        ...
        <div class="flex rounded-xl overflow-hidden mb-8 relative z-10 shadow">
            ...
            <div class="flex flex-col items-center rounded-l-xl bg-white py-28 lg:px-24 px-8">
                <img src="{{asset('icons/logo_eassessment.svg')}}" style="width: 150px; height: 150px;" class=" mb-8" alt="">
            ...
            <!-- section 2 -->
            <div class="flex-grow relative bg-gradient-to-tr from-accent-1 to-accent-2 rounded-r-xl p-8 hidden lg:flex items-center justify-center">
                <!-- Content for section 2 can go here -->
                <div class="bg-[#97DCF7] px-36 py-52 mx-20 rounded-2xl relative overflow-hidden">
                </div>
                <img src="{{asset('images/login_img.png')}}" class="absolute inset-0 w-full h-full object-contain" alt="">
            </div>
        </div>

        <!-- Top div -->
        <div class="absolute top-0 left-0 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-accent-2 rounded-full z-0"></div>

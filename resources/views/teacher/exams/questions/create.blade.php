                        ...
                        @foreach ($exam->questions as $index => $question)
                            <div class="flex pb-6 border-b mx-8 mb-6">
                                ...
                                <div class="flex flex-col flex-grow">
                                    ...
                                    <textarea name="questions[{{ $question->id }}][text]"
                                              class="w-full rounded-lg border-1 border-gray-400 mb-4"
                                              rows="8">{{ $question->question_text }}</textarea>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="mt-4 flex justify-end">
                <button id="confirmYes"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">Yes
                </button>
                <button id="confirmNo"
                        class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">No
                </button>
            </div>
        </div>
    </div>

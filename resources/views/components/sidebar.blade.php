    ...
    <div class="py-3 px-5 space-y-5">
        ...
        @if (auth()->user()->hasPermissionTo('admin-access'))
            ...
            <div class="relative">
                ...
                {{ request()->is('admin/data-admins*') || request()->is('admin/data-teachers*') || request()->is('admin/students*') ? 'text-white bg-gradient-to-r from-accent-1 to-accent-2' : 'bg-white' }}">
                    <div class="flex space-x-4">
                        <img src="{{ asset('icons/ic_database2.svg') }}"
                            class="{{ request()->is('admin/data-admins*') || request()->is('admin/data-teachers*') || request()->is('admin/students*') ? 'filter-white' : '' }}"
                ...
                <div id="accordionMenu1"
                    class="{{ request()->is('admin/data-admins*') || request()->is('admin/data-teachers*') || request()->is('admin/students*') ? 'flex' : 'hidden' }} flex-col mt-4 space-y-4 bg-white w-full">

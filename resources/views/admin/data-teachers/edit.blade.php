...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="mt-8 bg-white shadow-button rounded-lg pb-8 pt-4">
            <h1 class="font-semibold px-6 pb-4 text-lg">Edit Teacher</h1>
            <form action="{{ route('admin.data-teachers.update', $dataTeacher->id) }}" method="POST" class="px-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="flex flex-col w-full">
                        <div class="mb-4">
                            ...
                            <input type="text" name="contact" id="contact"
                                value="{{ old('contact', $dataTeacher->contact) }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="address" id="address"
                                value="{{ old('address', $dataTeacher->address) }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="teacher_id" id="teacher_id"
                                value="{{ old('teacher_id', $dataTeacher->teacher_id) }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        </div>
